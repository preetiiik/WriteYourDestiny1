  ...
  return (
    <div className="min-h-screen bg-white text-[#0a1a3d] overflow-x-hidden">
      ...
      {submitted && (
        ...
        >
          <div
            className="relative w-full max-w-md rounded-3xl bg-white px-7 py-8 sm:px-10 sm:py-10 text-center shadow-2xl"
            style={{
              animation: "wyd-success-popup 0.35s ease-out both",
            }}
          >
            {/* SUCCESS ICON */}
            <div
            ...
            <h2
              id="success-title"
              className="font-display text-2xl sm:text-3xl font-bold text-[#0a1a3d] mb-3"
            >
              Message Sent!
            </h2>

            {/* MESSAGE */}
            <p className="font-body text-sm sm:text-base text-[#6b7a99] leading-relaxed mb-7">
            ...
            <button
              ...
              className="w-full rounded-xl py-3.5 font-body text-sm font-semibold text-white transition-all duration-300 hover:opacity-90 hover:shadow-lg"
              style={{
